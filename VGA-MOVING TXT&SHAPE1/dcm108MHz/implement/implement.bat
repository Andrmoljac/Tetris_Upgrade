...
xst -ifn xst.scr
move dcm108MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm108MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm108MHz_exdes.ucf dcm108MHz_exdes

echo 'Running map'
map -timing -pr b dcm108MHz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm108MHz_exdes -w routed.ncd routed.vhd
cd ..
