...
xst -ifn xst.scr
move dcm25MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm25MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm25MHz_exdes.ucf dcm25MHz_exdes

echo 'Running map'
map -timing -pr b dcm25MHz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm25MHz_exdes -w routed.ncd routed.vhd
cd ..
