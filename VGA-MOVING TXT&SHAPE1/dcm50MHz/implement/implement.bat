...
xst -ifn xst.scr
move dcm50MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm50MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm50MHz_exdes.ucf dcm50MHz_exdes

echo 'Running map'
map -timing -pr b dcm50MHz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm50MHz_exdes -w routed.ncd routed.vhd
cd ..
